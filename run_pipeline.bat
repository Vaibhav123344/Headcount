...
start "Camera 1" cmd /k "cd /d %~dp0 && call .venv\Scripts\activate.bat && python workers\sct_worker.py --cam_id cam1 --source videos\cam1.mp4 --homography calibration\cam1_matrix.npy && pause"
start "Camera 2" cmd /k "cd /d %~dp0 && call .venv\Scripts\activate.bat && python workers\sct_worker.py --cam_id cam2 --source videos\cam2.mp4 --homography calibration\cam2_matrix.npy && pause"
